package com.company.Invoicemircoservice.service;


import com.company.Invoicemircoservice.model.Invoice;
import com.company.Invoicemircoservice.model.ProcessingFee;
import com.company.Invoicemircoservice.model.Tax;
import com.company.Invoicemircoservice.repository.InvoiceRepository;
import com.company.Invoicemircoservice.repository.ProcessingFeeRepository;
import com.company.Invoicemircoservice.repository.TaxRepository;
import com.company.Invoicemircoservice.util.feign.InvoiceClient;
...
import com.company.Invoicemircoservice.viewModel.InvoiceViewModel;
...
//    }
@Autowired
public GameStoreServiceLayer(InvoiceRepository invoiceRepo, TaxRepository taxRepo, ProcessingFeeRepository processingFeeRepo,InvoiceClient invoiceCient) {
    this.invoiceRepo = invoiceRepo;
    this.taxRepo = taxRepo;
    this.processingFeeRepo = processingFeeRepo;
    this.invoiceCient=invoiceCient;
}
...
//            ConsoleViewModel tempCon = null;
            ConsoleViewModel returnVal = invoiceCient.getConsole(invoiceViewModel.getItemId());
...
//            GameViewModel tempGame = null;
            GameViewModel returnVal = invoiceCient.getGameInfo(invoiceViewModel.getItemId());
...
//            TShirtViewModel tempTShirt = null;
            TShirtViewModel returnVal = invoiceCient.getTShirt((int) invoiceViewModel.getItemId());
